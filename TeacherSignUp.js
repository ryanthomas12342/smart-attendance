...
const TeacherSignUp = () => {
  const [formData, setFormData] = useState({ facultyId: '', name: '', email: '', password: '' });
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem' }}>
      <div style={{ maxWidth: '28rem', margin: '0 auto', backgroundColor: 'white', borderRadius: '1rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', padding: '2rem' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1.5rem' }}>Teacher Sign Up</h2>
        ...
        <p style={{ marginTop: '1.5rem', textAlign: 'center' }}>
          Already have an account? <Link to="/login/employee" style={{ color: '#3B82F6' }}>Log in here</Link>
        </p>
      </div>
    </div>
  );
